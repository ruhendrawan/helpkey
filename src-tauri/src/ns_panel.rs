...
const NSWindowStyleMaskNonActivatingPanel: i32 = (1 << 7) | (1 << 3);
// 0 Titled, 1 Closable, 2 Miniaturizable, 3 Resizable, 4 TexturedBackground (deprecated), 
// 5 UnifiedTitleAndToolbar, 6 FullScreen, 7 NonactivatingPanel, 8 HUDWindow
// 7 conflicts with 0 and 6
...
fn create_ns_panel(window: &Window<Wry>) -> ShareId<RawNSPanel> {
    ...
    // Ensures panel does not activate: Conflict with window decorations: true
